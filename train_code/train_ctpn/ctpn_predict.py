...
weights = os.path.join(config.checkpoints_dir, 'v3_ctpn_ep28_0.3658_0.1076_0.4734.pth')#'v3_ctpn_ep53_0.2326_0.1407_0.3733.pth') 'v3_ctpn_ep30_0.3699_0.0929_0.4628.pth'
...
if __name__ == '__main__':
    ...
    cv2.imwrite('D:/OCR/detect/data_result/data/006.jpg',image)
    # dis(image)